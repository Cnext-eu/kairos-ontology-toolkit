...
def _parse_split_annotations(mappings_dir: Path) -> dict[tuple[str, str], dict]:
    ...
    Delegates to the shared mapping parser.
    """
    from .mapping_parser import parse_split_annotations
    return parse_split_annotations(mappings_dir)
...
def _parse_skos_mappings(mappings_dir: Path) -> tuple[dict, dict[str, str]]:
    ...
    Delegates to the shared mapping parser. See
    :func:`projections.mapping_parser.parse_skos_mappings` for full docstring.
    """
    from .mapping_parser import parse_skos_mappings
    return parse_skos_mappings(mappings_dir)
