---
name: kairos-ontology-toolkit-dev
description: >
...
│       ├── kairos-ontology-hub-setup/SKILL.md
│       ├── kairos-ontology-modeling/SKILL.md
│       ├── kairos-ontology-validation/SKILL.md
│       ├── kairos-ontology-projection/SKILL.md
│       ├── kairos-ontology-toolkit-ops/SKILL.md
...
7. Update `kairos-ontology-projection` skill (both copies).
