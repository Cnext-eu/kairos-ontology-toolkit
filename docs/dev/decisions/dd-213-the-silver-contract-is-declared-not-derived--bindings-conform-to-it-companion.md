...
> Detailed specification for [DD-213](dd-213-the-silver-contract-is-declared-not-derived--bindings-conform-to-it.md).
...
> [DD-133](dd-133-v5-authoring-break--yaml-entitybinding--stateless-compile-companion.md) §2, §3, §3c, and §5.
...
- **The `contract.*` diagnostic catalog rows.** `docs/dev/diagnostic-codes.md` is drift-
