...
**Implementation:** No code changes required — Inspired classes are regular local classes already supported by all projectors. Guidance lives in skills and `docs/dev/dd-032-reference-model-alignment.md`.
...
- See `docs/dev/dd-032-reference-model-alignment.md` for full specification
