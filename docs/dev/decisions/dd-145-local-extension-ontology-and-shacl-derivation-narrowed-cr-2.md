...
CR-2 (the fast-path-to-Silver change request) originally proposed deriving a domain's
...
that is the logistics accelerator dbt/Silver design plan §7's "pending"
