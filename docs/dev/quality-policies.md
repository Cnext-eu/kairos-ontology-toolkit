...
See also: `docs/dev/dd-106-medallion-engineering-policy-v1.md` for the medallion policy context,
and `docs/guide/practitioner/data-engineer-methodology-guide.md` for the authoring workflow.
