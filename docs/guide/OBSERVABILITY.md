...
structured logs emitted during the same invocation. Per [DD-151](https://github.com/Cnext-eu/kairos-ontology-toolkit/blob/main/docs/dev/toolkit-design-decisions.md),
...
[diagnostic-codes.md](https://github.com/Cnext-eu/kairos-ontology-toolkit/blob/main/docs/dev/diagnostic-codes.md) for the full diagnostic code catalogue.
...
See [DD-151](https://github.com/Cnext-eu/kairos-ontology-toolkit/blob/main/docs/dev/toolkit-design-decisions.md) for the logging foundation, and
[DD-242](https://github.com/Cnext-eu/kairos-ontology-toolkit/blob/main/docs/dev/decisions/dd-242-one-command-run-is-one-trace-of-task-spans-and-opentelemetry-export-is-opt-in.md)
