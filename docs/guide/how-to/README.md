...
way see the [architecture](https://github.com/Cnext-eu/kairos-ontology-toolkit/blob/main/docs/dev/ontology-dbt-dataplatform-design-architecture.md) and
the [decision log](https://github.com/Cnext-eu/kairos-ontology-toolkit/blob/main/docs/dev/toolkit-design-decisions.md).
...
| Say how many of something a relationship allows | [Declare relationship cardinality](declare-relationship-cardinality.md) |
