...
| [DD-154](#dd-154-reserved-for-the-419-inventory-write-fix) | Reserved for the #419 inventory-write fix | Reserved | 2026-08-15 |
| [DD-155](#dd-155-reserved-for-the-426-managed-import-completeness-gate) | Reserved for the #426 managed-import completeness gate | Reserved | 2026-08-15 |
...
## DD-154: Reserved for the #419 inventory-write fix

**Status:** Reserved
**Date:** 2026-08-15

Number pre-assigned to the in-flight #419 fix (content-addressed inventory writes,
Package 1 of the 2026-08-14 dogfood plan) so parallel packages don't collide on DD
numbering. The landing PR replaces this stub with the full record.

---

## DD-155: Reserved for the #426 managed-import completeness gate

**Status:** Reserved
**Date:** 2026-08-15

Number pre-assigned to the in-flight #426 fix (Managed Import Completeness in
`validate --syntax` and `init --domain`, Package 2 of the 2026-08-14 dogfood plan).
The landing PR replaces this stub with the full record.
