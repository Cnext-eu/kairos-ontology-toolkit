...
| [DD-202](#dd-202-generate-bindings-recognizes-non-generatable-rows-before-asking-the-validator) | generate-bindings recognizes non-generatable rows before asking the validator | Accepted | 2026-08-20 |
| [DD-203](#dd-203-the-affinity-ai-provider-role-collapses-into-alignment-one-configured-provider-for-every-pre-modeling-call) | The affinity AI-provider role collapses into alignment: one configured provider for every pre-modeling call | Accepted | 2026-08-20 |
...
| [DD-206](#dd-206-branching-and-collaboration-guide-for-hub-and-dataplatform-repositories) | Branching and Collaboration Guide for Hub and Dataplatform Repositories | Accepted | 2026-08-27 |
...
| [DD-217](#dd-217-gold-projection-is-controllable-at-the-column) | Gold projection is controllable at the column | Accepted | 2026-09-04 |
...
`src/kairos_ontology/scaffold/skills/SC-merge-pr/SKILL.md`), `docs/RELEASING.md`
...
contradicted `docs/RELEASING.md` §5's own documented steady state — "Land `feat:` PRs on `main` over the
...
release, per the flow `docs/RELEASING.md` already documents (§5, §6, and the hotfix cases). Updated
...
references from `docs/RELEASING.md`'s back-merge notes.
